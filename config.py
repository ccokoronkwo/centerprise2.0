...
class DevelopmentConfig(object):
    ...
    SECURITY_PASSWORD_SALT = ''.join(random.choice(string.ascii_uppercase + string.digits) for x in range(32))


    #Flask-SQLAlchemy

    #SQLALCHEMY_DATABASE_URI = 'sqlite:///{}'.format(os.path.join(BASE_DIR, 'app.db'))
    SQLALCHEMY_DATABASE_URI = 'postgresql://postgres:Sunshine1@localhost/cp2'
